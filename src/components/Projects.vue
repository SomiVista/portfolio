...
const fetchedProjects: ProjectType[] = [
  {
    thumbnil: "/portfolio/assets/projects/Dreamdays.png",
    title: "Dreamdays",
    description:
  ...
  {
    thumbnil: "/portfolio/assets/projects/SNAPDAQ.png",
    title: "SNAPDAQ",
    description:
  ...
  {
    thumbnil: "/portfolio/assets/projects/Kubak.png",
    title: "Kubak",
    description:
  ...
  {
    thumbnil: "/portfolio/assets/projects/Goranee.png",
    title: "Goranee.ir",
    description:
  ...
  {
    thumbnil: "/portfolio/assets/projects/Jin724.png",
    title: "jin724com",
    description:
  ...
  {
    thumbnil: "/portfolio/assets/projects/Kurdcloud.png",
    title: "Kurdcloud",
    description:
    ...
    <div class="container mx-auto px-6 lg:px-20">
      ...
      <div class="space-y-16">
        <div
          ...
          :key="project.title"
          class="flex flex-col lg:flex-row items-center bg-white"
          :class="isOdd(index) ? 'rounded-r-lg' : 'rounded-l-lg'"
        >
          <img
          ...
          <div class="w-full lg:w-1/2">
            <h3 class="text-2xl font-semibold text-gray-800 mb-2 text-center">
              {{ project.title }}
            </h3>
